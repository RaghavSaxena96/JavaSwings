...
public class Forgot extends javax.swing.JFrame {
    ...
    public void Retrieve()
    {
        ...
        String sql="SELECT * FROM Account WHERE Answer='"+b+"'";
        try{
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next())
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 102)), "Forgot", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 36), new java.awt.Color(0, 204, 204))); // NOI18N
        ...
        setSize(new java.awt.Dimension(497, 506));
